...
<body>
    <div class="container">
        ...
        <form id="accountForm" action="update_account.php" method="POST" enctype="multipart/form-data">
            <div>
            ...
            <div class="form-actions">
                ...
                <button type="button" class="cancel-btn" onclick="window.location.href='admin_page.php'">Cancel</button>
            </div>
        </form>
    </div>
